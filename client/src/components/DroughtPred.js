...
// import test from '../static/bb.jpg'
function DroughtPred() {
  ...
  <div class="grid-cols-6">
    <div style={{backgroundImage:`url('Images/bb.jpg')`,backgroundSize:"cover"}} className="object-cover w-full rounded-lg h-[20vh] md:w-auto md:h-auto md:rounded-none md:rounded-l-lg">
