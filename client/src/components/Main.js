...
const Feature = () => {
  return (
    ...
    <section className="mb-32 text-gray-900 text-center">
      <h2 className="text-3xl font-bold mb-12">
        Why is it so<span className="text-green-600"> great?</span>
      </h2>
      <div className="grid md:grid-cols-3 lg:gap-x-12">
        <div className="mb-6 md:mb-0">
          <div className="p-4 bg-green-600 rounded-lg shadow-lg inline-block mb-6">
            <svg
          ...
          <h5 className="text-lg font-bold mb-4">User Experience</h5>
