  ...
  return (
    <div className='container m-auto px-7'>
      ...
      <div className='text-center mt-5'>
        <button onClick={()=>{setExtraActive(!extraActive)}} className="bg-green-500 px-1 font-semibold py-1 rounded">Add More</button>
      </div>
      <div>
        {extraActive&&<div>
