...
const systemMessage = {
  ...
  role: "system",
  content: "Explain things like you're talking to a farmer",
};
...
function BotGPT() {
  ...
  return (
    ...
    //   </div>
        ...
        <div className="px-4 rounded-md" style={{ height: "76vh" }}>
          {/* <ThemeProvider theme={theme}> */}
      <MainContainer >
              <ChatContainer >
                <MessageList style={{ background: `url('Images/xxxx 1.png')` , backgroundSize:'contain' }}
