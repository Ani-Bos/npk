...
function Developer(){
    return (
      <section className="bg-white dark:bg-black-300 mb-[6.5rem]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 className="mb-4 text-2xl tracking-tight font-semibold text-gray-900 dark:text-black">
              Our Team
            </h2>
            <p className="font-normal text-gray-500 sm:text-xl dark:text-gray-700">
              Our team isn't just a group of developers, but a collective of
              creative problem solvers who turn code into innovation.
            </p>
          </div>
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="text-center text-gray-500 dark:text-gray-500">
              ...
              <h3 className="mb-1 text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-700">
                <a href="#">Suraj Kumar Gupta</a>
              </h3>
              <p className="dark:text-gray-700 font-medium">Developer</p>
